...
### Solution Integrator | [Gambit Finance](https://gambit-finance.com/) | July 2023 - Now

Working on Kubernetes toolings and projects deployments in Azure and IBM Cloud
...
Automation scripts centered around the use of **Ansible** and **Docker** for deploying and managing various software stacks on my home servers,
as well as handling general maintenance and disaster recovery situations.
