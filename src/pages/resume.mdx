...
- Created a new Angular front-end in about 2 months, providing user-serviceable audience dashboards, as well as internal administration tools for CasterStats. Enabled marketing team to showcase the product at [IBC](https://en.wikipedia.org/wiki/International_Broadcasting_Convention) 2019, attracting a new influx of customers
- Migrated our legacy, customer tailored dashboard from .NET 4 to .NET 5 under a week, thus making sure we were ready to containerize and deploy the application on Linux
